# P4C-M4Z3-666AX — Build Plan (next agent brief)

**Genre:** maze-chase · **Era inspiration:** 1980 · **Target engine:** canvas-2d
...
(P4C-M4Z3-666AX). Mechanics are genre conventions; nothing is cloned — no code,
...
3. Depth loop (procedural variety, moddable rules) — modules: MazeGrid, ChaseAI.
